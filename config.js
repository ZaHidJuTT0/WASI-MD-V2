...
global.THUMB_IMAGE = process.env.THUMB_IMAGE || process.env.IMAGE || "https://telegra.ph/file/428e34a02d19df5fa6bd1.jpg";
...
global.userImages = process.env.USER_IMAGES || "https://telegra.ph/file/428e34a02d19df5fa6bd1.jpg";
...
module.exports = {
  ...
  caption: process.env.CAPTION || "> `𓆩𝐈𝛕ᷟ‌𝚣⃪̭ꙴ𐎓⃝⃪⃯𝐌⃪͢Ꝛ፝֟ᚚ͓𝐙͎𝒊͢͠𝙙𝒊͎𝒊͎̽𓆪`",
  author: process.env.PACK_AUTHER || "🦋",
  packname: process.env.PACK_NAME || "穆罕默德  ̶ ᷦ ̶ͥ ͩ ̶ͥ ̶ͥ🩵̶³̶🪽",
  botname: process.env.BOT_NAME || "`𓆩𝐈𝛕ᷟ‌𝚣⃪̭ꙴ𐎓⃝⃪⃯𝐌⃪͢Ꝛ፝֟ᚚ͓𝐙͎𝒊͢͠𝙙𝒊͎𝒊͎̽𓆪`",
